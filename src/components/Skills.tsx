  ...
  return (
    <section id="skills" className="py-20 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Card Container & Tech Badges */}
        <div className="apple-glass rounded-2xl sm:rounded-3xl p-6 sm:p-10 border border-black/5 dark:border-white/10 shadow-2xl relative overflow-hidden min-h-[160px] flex items-center justify-center">
          
          {/* Subtle Ambient Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-36 bg-[#3744bd]/10 dark:bg-[#3744bd]/15 blur-[90px] rounded-full pointer-events-none -z-10" />
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-3.5 max-w-4xl">
            {displayedSkills.map((skill, index) => (
              <div
                ...
                className="group flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-black/5 dark:bg-[#0c0f1f]/85 border border-black/5 dark:border-white/10 hover:border-white/25 hover:bg-black/10 dark:hover:bg-[#161a33] transition-all duration-200 hover:scale-105 hover:-translate-y-0.5 shadow-sm hover:shadow-md cursor-default select-none animate-in fade-in zoom-in-95 duration-150"
              >
